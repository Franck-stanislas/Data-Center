...
const Localisation = ({setProject}) => {
    ...
    return (<form className="container">
        <div className="d-block mt-4 mb-md-0">
            <p className="mb-0">{t('Origine du projet')}.</p>

            <div className="mb-4 mt-2">
                <label className="my-1 me-2" htmlFor="country">{t('Region')}</label>
            ...
            <div className="mb-4 mt-2">
                <label className="my-1 me-2" htmlFor="country">{t('Département')}</label>
                <select className="form-select" id="country" aria-label="Default select example"
            ...
            <div className="mb-4 mt-2">
                <label className="my-1 me-2" htmlFor="country">{t('Arrondissement')}</label>
                <select className="form-select" id="country" aria-label="Default select example"
